<template>
  <div class="nav" :class="nav_change">
    ...
    <div class="nav-body" @click="navBody">
      ...
      <div class="nav-shop">
        <ul>
          <li v-for="(asrc,i) of shoplist" :key="i">
            <a :href="asrc.href">
              <div>
                <img :src="asrc.src" alt />
              </div>
      ...
      <div class="nav-other">
        <ul v-if="!reduce">
          <li v-for="(asrc,i) of otherlist" :key="i">
            <a :href="asrc.href">
              <div>
                <img :src="asrc.src" alt />
              </div>
        ...
        <ul v-else>
          <li v-for="(asrc,i) of otherlist2" :key="i">
            <a :href="asrc.href">
              <div>
                <img :src="asrc.src" alt />
              </div>
      ...
      <div class="nav-onlinegame">
        <ul v-if="!reduce">
          <li v-for="(asrc,i) of onlinegamelist" :key="i">
            <a :href="asrc.href">
              <div>
                <img :src="asrc.src" alt />
              </div>
        ...
        <ul v-else>
          <li v-for="(asrc,i) of onlinegamelist2" :key="i">
            <a :href="asrc.href">
              <div>
                <img :src="asrc.src" alt />
              </div>
  ...
  data() {
    return {
      mainlist: [
        ...
        {
          href: "#",
          src: require("../assets/nav_img/play-circle.png"),
          name: "视频",
          hovered: false,
        },
        {
        ...
        { href: "#", src: require("../assets/nav_img/adn.png"), name: "文章" ,hovered: false,},
        {
          href: "#",
