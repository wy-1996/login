<template>
  <div class="refer">
                  ...
                  <li class="refer_li" v-for="(li,k) of refer" :key="k">
                      ...
                      <div class="li_sec_div">
                          <div>
                              ...
                              <div>
                                  <div class="sec_tou">
                                        <div><img src="../../assets/images/newImgs/sec_tou.jpg"></div>
                                        <span>资讯</span>
                                        <span>15849人订阅</span>
                                        <hr>
                                        <button>订阅</button>
                      ...
                      <div class="li_fou_div">
                          <div class="four_div1">
                              ...
                              <div>
                                  <div class="four_div3">
                                        <p></p>
                                        <div><img src="../../assets/images/newImgs/iconTou.gif"></div>
                                        <span>{{li.Pauthor}}</span>
                                        <span>999人关注</span>
                                        <hr>
                                        <span>ta的最新发布</span>
                                        <ul><li v-for="(newLi,n) of newArr" :key="n">{{newLi}}</li></ul>
                                        <hr>
                                        <div>
                                            <button>关注</button>
                                            <button>私信</button>
                          ...
                          <div class="four_div2">
                              <div><img src="../../assets/images/newImgs/zan.png">{{li.Pup}}</div>
                              <div><img src="../../assets/images/newImgs/msg.png">{{li.Pcomment}}</div>
                          </div>
                      </div>
                  </li>
              </ul>
      ...
      <div class="page">
            <ul>
                <li @click="prevPage" :disabled="isTrue1==1" :class="isShow1==1?'page_prev':'page_prev_hidden'"><div>上一页</div></li>
                <li @click="changePage(k+1)" :class="page==k+1?'page_center_check ':' page_center'"
                 v-for="(pageItem,k) of pagecount" :key="k"><div>{{pageItem}}</div></li>
                <li @click="nextPage" :disabled="isTrue2==1" :class="isShow2==1?'page_next':'page_next_hidden'"><div>下一页</div></li>
            </ul>
      </div>
  </div>
</template>
...
export default {
    ...
    methods: {
        aaa(){   //请求当前页码的数据方法
            this.axios.get('/refer',{params:{page:this.page}}).then(res=>{
...
.four_div1>div:first-child:hover,.four_div1>div:nth-child(2):hover{
    opacity: 0.8;
}
...
/* 上一页，下一页不可点击状态 */
.page_prev_hidden>div,.page_next_hidden>div{
    width:0.85rem;
    height: 0.35rem;
    color:#aaa;
