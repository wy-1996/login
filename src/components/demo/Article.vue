<template>
  <div class="article">
    <div>
      ...
      <div>
        <ul class="article_ul">
          <li class="article_li" v-for="(li,k) of article" :key="k">
            ...
            <div class="li_sec_div">
              <div>
                ...
                <div>
                  <div class="sec_tou">
                    <div>
                      <img src="../../assets/images/articlePic/sec_tou.jpg" />
                    </div>
                    <span>资讯</span>
                    <span>15849人订阅</span>
                    <hr />
            ...
            <div class="li_fou_div">
              <div class="four_div1">
                <div>
                  <img src="../../assets/images/articlePic/iconTou.gif" />
                </div>
                <div>
                  <h3>{{li.Pauthor}}</h3>
              ...
              <div class="four_div2">
                <div>
                  <img src="../../assets/images/articlePic/zan.png" />
                  {{li.Pup}}
                </div>
                <div>
                  <img src="../../assets/images/articlePic/msg.png" />
                  {{li.Pcomment}}
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    aaa() {
      //请求当前页码的数据方法
      this.axios.get("/article", { params: { page: this.page } }).then((res) => {
        let data = res.data.results;
        this.pagecount = res.data.pagecount;
        data.forEach((li) => {
          li.Pimage = require("../../assets/images/articlePic/" + li.Pimage);
          this.article.push(li);
        });
      });
    },
    changePage(pgk) {
      ...
      this.article.length = 0; //将当前数组清空  this.article=[]
      this.aaa(); //请求当前页码数据
    },
    prevPage() {
      //切换上一页
